...
namespace segundo_parcial
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double porcentaje1 = ((candidato1 * 100) / 1000);//aqui se saca el porcentaje de los votos de todos los candidato
            double porcentaje2 = ((candidato2 * 100) / 1000);
            double porcentaje3 = ((candidato3 * 100) / 1000);
            double porcentaje4 = ((candidato4 * 100) / 1000);
            ...
            if (votos==1000)// si el conteo de los votos llega a 1000, se procede a buscar el ganador
            {
                    ...
                    else if (candidato4 > candidato2 && candidato4 > candidato3 && candidato4 > candidato1)//condicion, por si gana el cuarto candidato
                {
                    ...
                    {
                        Console.WriteLine("Hay empate, Segunda vuelta");
                    }
            }
        }
    }
